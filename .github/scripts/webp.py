...
# Só a galeria (assets/img/trabalhos/) emite srcset — ver srcsetWebp() em
# assets/js/app.js. Gerar variantes para rigidos/modelos/lonas punha 1,8 MB de
# ficheiros no repositório que nenhuma página pede.
PASTAS = ['trabalhos']
